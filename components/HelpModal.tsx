  ...
  <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in font-sans" onClick={onClose}>
    <div className="bg-white w-[650px] max-h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden" onClick={e => e.stopPropagation()}>
      ...
      <div className="p-6 overflow-y-auto custom-scrollbar text-slate-600 text-sm space-y-8">
        ...
        <section className="space-y-3">
          <h3 className="text-base font-black text-slate-800 flex items-center gap-2 border-l-4 border-amber-400 pl-2">
            <MonitorCheck size={18} className="text-amber-500" /> 단축키 (Hotkeys)
          </h3>
          <div className="grid grid-cols-2 gap-2 pl-3 text-xs text-slate-600 bg-slate-50/50 p-2 rounded-lg border border-slate-100">
            <div className="flex items-center gap-2 font-mono bg-white px-1 border rounded shadow-sm text-slate-700 w-fit">Space</div> <span><b>재생 / 정지</b> (현재 탭)</span>
            <div className="flex items-center gap-2 font-mono bg-white px-1 border rounded shadow-sm text-slate-700 w-fit">Ctrl + Z</div> <span><b>실행 취소</b> (Undo)</span>
            <div className="flex items-center gap-2 font-mono bg-white px-1 border rounded shadow-sm text-slate-700 w-fit">Ctrl + S</div> <span><b>보관함 저장</b> (Save)</span>
            <div className="flex items-center gap-2 font-mono bg-white px-1 border rounded shadow-sm text-slate-700 w-fit">Ctrl + Shift + S</div> <span><b>파일 내보내기</b> (Export)</span>
            <div className="flex items-center gap-2 font-mono bg-white px-1 border rounded shadow-sm text-slate-700 w-fit">Tab</div> <span><b>그리기 모드 전환</b> (성도 시뮬레이터 전용)</span>
          </div>
        </section>
