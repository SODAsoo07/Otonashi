                        ...
                        {sidebarTab === 'settings' ? (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4 bg-slate-50 p-3 rounded-xl border border-slate-200">
                                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2"><Mic2 size={12}/> Excitation Source (성대/소스)</h3>
                                    ...
                                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2"><Wind size={12}/> Noise Source (Breath/Air)</h3>
                                    <div className="flex gap-2 p-1 bg-slate-200 rounded-lg shadow-inner">
